  ...
  return (
    <div className={styles.mmCntnr}>
      ...
      <div className={styles.mmInfo}>
        <p>Belive it or not I do find things outside of coding cool, below are five boxes that link to something random I find interesting and I hope you do too.</p>
      </div>
